...
export default {
	...
	data() {
		let that = this,
			...
			// lang = language[this.langType] ? language[this.langType] : language['en'],
	...
	methods: {
		...
		prepareUpload(){
			...
			this.$emit('crop-success', createImgUrl);
        }
    },
	created(){
		// 绑定按键esc隐藏此插件事件
...
.vue-image-crop-upload {
  ...
  .vue-image-crop-upload .vicp-wrap {
    ...
    .vue-image-crop-upload .vicp-wrap .vicp-close {
      ...
      right: 20px;
      top: 20px; 
	  background: url('../../assets/theme-default/images/usercenter/btn_close.png') no-repeat;
